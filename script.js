...
const typingSpeed = 1000; // Adjust the speed (milliseconds per character)
...
infoButton.addEventListener('click', () => {
    detailsContent.innerHTML = " <h4>WELCOME!</h4><p>DEVELOPED BY KANISTAN E21</p>";
...
teams.forEach((team, index) => {
    ...
    back.className = 'back';
    back.textContent = `${team.points} points`;
...
games.forEach((game) => {
    ...
    if (game.name === 'Football') {
        gameBox.style.backgroundImage = 'url("image/football.jpeg")';
    } else if (game.name === 'Cricket') {
        gameBox.style.backgroundImage = 'url("image/cricket.jpeg")';
    } else if (game.name === 'Chess') {
        gameBox.style.backgroundImage = 'url("image/chess.jpeg")';
    } else if (game.name === 'Dancing') {
        gameBox.style.backgroundImage = 'url("image/Dancing.jpeg")';
    } else if (game.name === 'Drama') {
        gameBox.style.backgroundImage = 'url("image/drama.jpeg")';
    } else if (game.name === 'Batminton') {
        gameBox.style.backgroundImage = 'url("image/batminton.jpeg")';
    } else if (game.name === 'Art') {
        gameBox.style.backgroundImage = 'url("image/art.jpeg")';
    } else if (game.name === 'Gaming') {
        gameBox.style.backgroundImage = 'url("image/gaming.jpeg")';
    } else if (game.name === 'Netball') {
        gameBox.style.backgroundImage = 'url("image/netball.jpeg")';
    } else if (game.name === 'Singing') {
        gameBox.style.backgroundImage = 'url("image/singing.jpeg")';
    } else if (game.name === 'Sort film') {
        gameBox.style.backgroundImage = 'url("image/sort film.jpeg")';
    } else if (game.name === 'Vollyball') {
        gameBox.style.backgroundImage = 'url("image/vollyball.jpeg")';
    } else if (game.name === 'E speaker') {
        gameBox.style.backgroundImage = 'url("image/E Speaker.jpeg")';
    } else if (game.name === 'Poem') {
        gameBox.style.backgroundImage = 'url("image/poem.jpeg")';
    } else if (game.name === 'Debat') {
        gameBox.style.backgroundImage = 'url("image/debat.jpeg")';
    } 
